        ...
        >
             ...
             <div className="bg-[#1a237e] p-6 text-center border-b-4 border-[#5c6bc0] shadow-xl relative overflow-hidden">
                <div className="absolute top-0 left-0 w-full h-full opacity-20 bg-[url('https://www.transparenttextures.com/patterns/stardust.png')]"></div>
                 ...
                 <p className="text-blue-200 text-lg font-bold mt-2 uppercase tracking-widest relative z-10">
             ...
             <div className="max-w-4xl mx-auto mt-8 p-4">
                 <div className="bg-gradient-to-b from-blue-900 to-blue-800 rounded-3xl p-8 border-4 border-blue-400 shadow-[0_0_30px_rgba(59,130,246,0.5)] text-center relative overflow-hidden">
                     ...
                     <h2 className="text-2xl font-bold text-blue-200 mb-6 uppercase tracking-wider flex items-center justify-center gap-2">
                     ...
                     <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-16">
                         <div className="flex flex-col items-center">
                             <span className="text-8xl md:text-9xl font-bold text-white drop-shadow-xl">{weather.temp}°</span>
                             <span className="text-blue-300 font-bold uppercase mt-2">Temperatur</span>
                         </div>
                         <div className="w-1 h-24 bg-blue-500/30 hidden md:block"></div>
                         <div className="flex flex-col items-center">
                             ...
                             <span className="text-xl md:text-2xl font-bold text-yellow-300">{weather.condition}</span>
                         </div>
                     </div>
                 </div>
             </div>
             ...
             {elfConfig && (
                <div className="max-w-4xl mx-auto mt-8 px-4">
                    <div className="bg-[#2d1b14] rounded-3xl p-6 border-4 border-[#855E42] shadow-2xl relative">
                        <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 bg-elf-gold text-elf-dark px-6 py-1 rounded-full font-bold border-2 border-[#855E42] shadow-lg">
                            Wie brav seid ihr?
                        </div>
                        <div className="mt-4 grid gap-6 grid-cols-1 md:grid-cols-2">
                            {elfConfig.kids.map(kid => {
                                ...
                                return (
                                    <div key={kid.name} className="bg-black/30 p-4 rounded-xl border border-white/10">
             ...
             <div className="mt-12 px-4">
                 <div className="bg-[#fcfaf2] rounded-3xl p-6 md:p-8 max-w-5xl mx-auto shadow-2xl border-4 border-[#855E42] relative">
                     {/* Decoration */}
                     <div className="absolute -top-6 left-1/2 transform -translate-x-1/2 bg-[#D42426] text-white px-8 py-2 rounded-full font-bold text-xl shadow-lg border-2 border-[#855E42]">
                         Wichtel-Bäckerei
                     </div>
